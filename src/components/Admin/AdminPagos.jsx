...
import styles from './../../styles/AdminPagos.module.css';
...
export default function AdminPagos() {
  ...
  // Reusa el mismo endpoint que ya consume AdminTramites.jsx.
  ...
  return (
    <div className={styles.page}>
      <AdminSidebar active="pagos" onNavigate={handleNavigate} />

      <main className={styles.main}>
        <header className={styles.topbar}>
          <div>
            <div className={styles.crumb}><span>Principal</span> <span className={styles.crumbSep}>/</span> <span className={styles.accent}>Pagos</span></div>
