          ...
          <div className={styles.footerGrid}>
            <div className={styles.footerBrand}>
              ...
              <div className={styles.footerSocial}>
                ...
                <a href="https://wa.me/527771008412" target="_blank" rel="noreferrer" className={styles.wa} aria-label="WhatsApp"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 17 0z" /></svg></a>
