...
export default function EmpresaClientes() {
  ...
  return (
    <div className={styles.page}>
      <EmpresaSidebar active="clientes" clientesCount={totalActivos} onNavigate={handleNavigate} />

      <main className={styles.main}>
        <header className={styles.topbar}>
          <div>
            <div className={styles.crumb}><span>Empresa</span> <span className={styles.crumbSep}>/</span> <span className={styles.accent}>Clientes</span></div>
