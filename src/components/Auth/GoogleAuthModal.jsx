...
const TEL_URL = 'tel:+527772193613';
          ...
          {step === 'alts' && (
            <div>
              ...
              <button type="button" className={styles.altCard} onClick={handleLlamar}>
                ...
                <div><div className={styles.altName}>Llamar a Consultoría JAS</div><div className={styles.altSub}>777 219 3613 · L–S 9:00–18:00</div></div>
                <span className={styles.altArrow}><ExternalArrowIcon /></span>
              </button>
